...
angular.module('partyBidApp')
    ...
    $scope.start=function(){
        ...
        for(var i in active)
        {
//            for(var j=0;j<=active[i].bid_name.length;j++)


            if(active[i].bid_name.length==0)
            {
                active[i].bid_name="竞价1"
...
//        var bid_list= _.findWhere(active,{name:activity_name}).bidlist;
//        if (bid_list.length == 0)
//            return '竞价1';
//        return '竞价' + (bid_list.length + 1);
//        for(var i in active)
//        {
//            for(var j=0;j<=active[i].bid_num.length;j++)
//            {
//                active[i].bid_num.unshift(bid_name)
//                $scope.list3=active[i].bid_num;
//            }
